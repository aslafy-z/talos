...
const (
	BlockDiskHealthSource_DISK_HEALTH_SOURCE_UNSUPPORTED BlockDiskHealthSource = 0
...
var (
	BlockDiskHealthSource_name = map[int32]string{
		0: "DISK_HEALTH_SOURCE_UNSUPPORTED",
...
const file_resource_definitions_enums_enums_proto_rawDesc = "" +
	...
	"\x0fWOL_MODE_FILTER\x10\x80\x01*t\n" +
	"\x15BlockDiskHealthSource\x12\"\n" +
	"\x1eDISK_HEALTH_SOURCE_UNSUPPORTED\x10\x00\x12\x1b\n" +
	"\x17DISK_HEALTH_SOURCE_NVME\x10\x01\x12\x1a\n" +
	"\x16DISK_HEALTH_SOURCE_ATA\x10\x02*\xb5\x01\n" +
